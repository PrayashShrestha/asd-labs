...
import edu.mum.cs.cs525.labs.skeleton.car.gears.*;
...
public class Lab08 extends javax.swing.JFrame
{
    ...
    public GearState getParkedState() {
        return parkedState;
    }

    public GearState getGear1() {
        return gear1;
    }

    public GearState getGear2() {
        return gear2;
    }

    public GearState getGear3() {
        return gear3;
    }

    public GearState getGear4() {
        return gear4;
    }

    public GearState getGear5() {
        return gear5;
    }
    ...
    public Lab08()
    {
        parkedState = new Parking(this);
        gear1 = new GearOne(this);
        gear2 = new GearTwo(this);
        gear3 = new GearThree(this);
        gear4 = new GearFour(this);
        gear5 = new GearFive(this);
